...
public enum JczqHalfFullRaceResultEnum implements EnumBase {
	...
	private JczqHalfFullRaceResultEnum(RaceResultEnum half,
			RaceResultEnum full, String message) {
		this.half = half;
		this.full = full;
		this.message = message;
	}

	public static final JczqHalfFullRaceResultEnum halfFullOf(
			RaceResultEnum half, RaceResultEnum full) {
		for (JczqHalfFullRaceResultEnum enumObj : JczqHalfFullRaceResultEnum
				.values()) {
	...
	public static JczqHalfFullRaceResultEnum safeValueOf(String name) {
		for (JczqHalfFullRaceResultEnum jczqHalfFullRaceResultEnum : JczqHalfFullRaceResultEnum
				.values()) {
