 ...
 */
public enum JczqHhggEnum implements HhggEnum {
    ...
    public String standardMessage() {
        //return OptionsHelper.optionShow(this.realResultEnum, this.subType);

        return null;
    }

    private JczqHhggEnum(String message, EnumBase realResultEnum, LotterySubTypeEnum subType) {
        this.message = message;
        this.subType = subType;
        this.realResultEnum = realResultEnum;
    }

    public static JczqHhggEnum valueOfRealResultEnumValue(EnumBase realResultEnum) {
        for (JczqHhggEnum option : JczqHhggEnum.values()) {
    ...
    public static List<JczqHhggEnum> valueOfRealResultEnumValues(List<EnumBase> realResultEnums) {
        List<JczqHhggEnum> returnList = new ArrayList<JczqHhggEnum>();
     ...
     * @return
     */
    public static JczqHhggEnum valueOfSubTypeRealName(LotterySubTypeEnum subType, String option) {
        for (JczqHhggEnum hhggEnum : JczqHhggEnum.values()) {
    ...
    public static List<JczqHhggEnum> valueOfSubTypeRealNames(LotterySubTypeEnum subType, List<String> options){
        List<JczqHhggEnum> returnList = new ArrayList<JczqHhggEnum>();
