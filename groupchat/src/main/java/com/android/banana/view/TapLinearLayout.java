...
public class TapLinearLayout extends LinearLayout {
    ...
    public TapLinearLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TapLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
