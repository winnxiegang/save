...
public class ArrayUtils {
	...
	public static <T> T get(T[] arrays, int index) {
		return arrays == null ? null : (arrays.length <= index ? null
				: arrays[index]);
	}

	public static <T> T[] subarray2(T[] array, int startIndexInclusive,
	...
	public static int hashCode(Object array) {
		...
		if (array instanceof long[]) {
			...
			for (double aDoubleArray : doubleArray) {
				long longBits = Double.doubleToLongBits(aDoubleArray);
			...
			for (float aFloatArray : floatArray) {
				hashCode = (hashCode * MULTIPLIER_NON_ZERO_ODD_NUMBER)
						+ Float.floatToIntBits(aFloatArray);
			}
			...
			for (Object anObjectArray : objectArray) {
				hashCode = (hashCode * MULTIPLIER_NON_ZERO_ODD_NUMBER)
						+ hashCode(anObjectArray);
			}
		}
	...
	public static List toList(Object array, List list) {
		...
		if (!array.getClass().isArray()) {
			...
			for (boolean aBooleanArray : booleanArray) {
				list.add(aBooleanArray ? Boolean.TRUE : Boolean.FALSE);
			}
		} else if (array instanceof char[]) {
			char[] charArray = (char[]) array;
	...
	public static boolean containsToString(Object[] array, Object objectToFind) {
		return indexOf(ArrayUtils.convertToString(array),
				ObjectUtils.toString(objectToFind)) != -1;
	}
	...
	public static List<Long> convertToLongList(String[] values) {
		...
		for (String value : values) {
			ret.add(Long.parseLong(StringUtils.trim(value)));
		}
		return ret;
	}
	...
	public static <T> List<String> convertToString(List<T> values) {
		if (values == null)
			return null;
		List<String> returnList = new ArrayList<>(values.size());
		for (T value : values) {
