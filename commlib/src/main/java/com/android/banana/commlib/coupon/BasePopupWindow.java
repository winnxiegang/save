...
/**
 * Created by lingjiu on 2017/7/10.
 */
public class BasePopupWindow extends PopupWindow {
    ...
    //是否支持阴影背景
    private boolean isSupportShadow = false;
    protected View parentView;

    public void setSupportShadow(boolean supportShadow) {
        isSupportShadow = supportShadow;
    }

    public BasePopupWindow(Context context, int width, int height) {
        this.mContext = context;
        initBasePopupWindow(height, width);
    }
     ...
     * @param width
     */
    private void initBasePopupWindow(int height, int width) {
