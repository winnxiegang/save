...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static final float CENTER_RADIUS = 8.75f; //should put up to 10 when + stroke_width
    ...
    private static class Ring {
        ...
        // animating, the mColorIndex moves by one to the ok available color.
        ...
        /**
         * Proceed to the ok available ring color. This will automatically
