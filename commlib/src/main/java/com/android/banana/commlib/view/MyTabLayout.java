...
public class MyTabLayout extends HorizontalScrollView {
     ...
     */
    public MyTabLayout setSelectedTabIndicatorColor(@ColorInt int color) {
     ...
     */
    public MyTabLayout setOnTabSelectedListener(OnTabSelectedListener onTabSelectedListener) {
    ...
    public MyTabLayout setTabTypeface(Typeface tabTypeface){
        mTabTypeface = tabTypeface;
        return this;
    }
    ...
    public MyTabLayout setTabSelectedListener(TabSelectedListener listener1) {
    ...
    private class MaterialTabSelectedAdapter implements OnTabSelectedListener {
