...
public class SendCouponDialog extends DialogBase implements OnHttpResponseListener, View.OnClickListener, LiveCouponCallback {
    ...
    public SendCouponDialog(Context context, int orientation, String objectType, String objectId) {
            ...
            switch (((CouponUrlEnum) requestContainer.getRequestEnum())) {
                ...
                case COUPON_CREATE:
                    ...
                    if ("AVAIABLE_AMOUNT_NOT_ENOUGH".equals(name)) {
                        ToastUtil.showLong(context.getApplicationContext(), "您的金币不够");
                        return;
                    }
