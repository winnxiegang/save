...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private String saveCrashInfoToFile(Throwable ex) {
        ...
        Log.e(TAG, "saveCrashInfoToFile: " + result);
        printWriter.close();
        mDeviceCrashInfo.put(STACK_TRACE, result);
        try {
            long timestamp = System.currentTimeMillis();
            SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String timestamp_str = format.format(new Date(timestamp));
            String fileName = "crash-" + timestamp_str + CRASH_REPORTER_EXTENSION;
            // 保存文件
            String path = Environment.getExternalStorageDirectory().getPath() + File.separator + "hhs_crash";
