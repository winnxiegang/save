 ...
 */
public class AnalysisAdapter extends MyBaseAdapter<RankCountBean> {


    public AnalysisAdapter(Context context, List<RankCountBean> list) {
...
//        String homeTeamLogoUrl = String.format(AppParam.FT_IMAGE_DOWNLOAD_URL,rankCountBean.getHomeRankDataMap().getHome().getTid());
//
//        String guestLogoUrl = String.format(AppParam.FT_IMAGE_DOWNLOAD_URL, rankCountBean.getGuestRankDataMap().getGuest().getTid());
        String homeTeamLogoUrl = TeamImageUrlUtils.getFTHomeLogoUrl(rankCountBean.getHomeRankDataMap().getHome().getTid());

        String guestLogoUrl =TeamImageUrlUtils.getFTGuestLogoUrl(rankCountBean.getGuestRankDataMap().getGuest().getTid());
        setJczqTeamLogo(viewHolder.rcHomeTeamIv, homeTeamLogoUrl, true);

        setJczqTeamLogo(viewHolder.rcGuestTeamIv,guestLogoUrl, false);

        viewHolder.rcHomeTeamNameTv.setText(rankCountBean.getHomeRankDataMap().getHome().getTn());

        viewHolder.rcGuestTeamNameTv.setText(rankCountBean.getGuestRankDataMap().getGuest().getTn());
