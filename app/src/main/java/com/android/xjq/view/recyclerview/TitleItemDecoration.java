...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public TitleItemDecoration(Context context
        ...
        mTextPaint.setTextSize(UiUtils.sp2px(mCtx, 14));
        ...
        topGap = res.getDimensionPixelSize(R.dimen.dp30);
        alginBottom = res.getDimensionPixelSize(R.dimen.dp30);
        mGravity = gravity;
    }
...
//                int height = mTarView.getMeasuredHeight();
                ...
                int top = view.getTop();
                Bitmap bitmap = UiUtils.view2Bitmap(v);
                Drawable drawable = UiUtils.bitmap2Drawable(mActivity.getResources(), bitmap);
...
//                    c.drawText(textLine, right - bounds.width(), bottom, mTextPaint);
    ...
    private void drawTextOver(Canvas c, RecyclerView parent, int itemCount, int left, int right, String groupId, View view, int pos, String firstLine) {
        ...
        switch (mGravity) {
            case GRAVITY_LEFT:
                c.drawText(firstLine, parent.getPaddingRight() + 30
